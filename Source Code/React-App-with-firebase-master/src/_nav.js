...
const _nav = [
  ...
  },
  {
    ...
    icon: <CIcon icon={cilNotes} customClassName="nav-icon" />, // Optional: Choose an icon
    items: [
      {
        component: CNavItem,
        name: 'Add Roles',
  ...
  },
  {
    ...
    icon: <CIcon icon={cilUser} customClassName="nav-icon" />, // Optional: Choose an icon
    items: [
      {
        component: CNavItem,
        name: 'Add Users',
  ...
  },
  {
    ...
    icon: <CIcon icon={cilGrid} customClassName="nav-icon" />, // Optional: Choose an icon
    items: [
      {
        component: CNavItem,
        name: 'Add Category',
  ...
  },
  {
    ...
    icon: <CIcon icon={cilBasket} customClassName="nav-icon" />, // Optional: Choose an icon
    items: [
      {
        component: CNavItem,
        name: 'Add Product',
...

  {
    component: CNavGroup,
    name: 'Trending-Prod',
    icon: <CIcon icon={cilShareBoxed} customClassName="nav-icon" />, // Optional: Choose an icon
    items: [
      {
        component: CNavItem,
        name: 'Trend Product',
        to: 'Trendprod/addTrendProd',
      }, {
        component: CNavItem,
        name: 'View Trend Product',
        to: 'Trendprod/viewTrendProd',
      },
    ],
  },

  {
    component: CNavGroup,
    name: 'Feedback',
    icon: <CIcon icon={cilBook} customClassName="nav-icon" />, // Optional: Choose an icon
    items: [
      // {
      //   component: CNavItem,
      //   name: 'Trend Product',
 ...
 
  {
    ...
    icon: <CIcon icon={cilDescription} customClassName="nav-icon" />, // Optional: Choose an icon
    items: [
      // {
      //   component: CNavItem,
      //   name: 'Add Orders',
